        ...
        <div class="container-header">
            ...
            <nav class="menu">
                ...
                <ul>
                    ...
                    <li class="dropdown nav-link @if (request()->routeIs('product')) {{ 'active' }} @endif " ><a href="/product">PRODUCT</a>
            ...
            <div class="header-right">
                ...
                <a href="/cart">                <div class="cart-btn icon-btn">
