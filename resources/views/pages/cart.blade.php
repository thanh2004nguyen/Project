...
<section class="cart-body">
    ...
    <div class="container my-4">
        <table id="cart-table" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    <td><img src="{{$item->product->images[0]->url}}" 
                        alt="{{$item->product->images[0]->url}}"  height="100%">
                    </td>
                                    ...
                                    <div class="col-sm-6">
                                        <table id="city-select">
                                            <tr>
                                                ...
                                                <td>Dictrict<span style="color: red;">*</span></td>
                                                <td>
                                                ...
                                                <td>Warld<span style="color: red;">*</span></td>
                                                <td>
    ...
    <div class="container" >
        <div class="continue-check-area" style="justify-content:space-evenly" >
